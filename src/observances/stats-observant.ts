...
export class StatsObservant {
    ...
    public constructor() {
        this._pixiStatsPlugin = new PixiStatsPlugin(getApplication());
    ...
    private _hideStats(): void {
        ...
        getApplication().ticker.remove(this._updateStats, this);
    }

    private _showStats(): void {
        document.body.appendChild(this._pixiStatsPlugin.stats.dom);
        getApplication().ticker.add(this._updateStats, this);
    }
